...
\begin{center}
  \begin{tabular}{|p{2cm}|c|c|c|p{8cm}|}
	...
	Port number & INTEGER & 2 & The client's UDP port number, used for communication between peers.\\ \hline
...
\begin{center}
  \begin{tabular}{|p{2cm}|c|c|c|p{8cm}|}
	...
	\end{itemize} 
	The rest of the message is ignored when Answer is not 0x00. \\ \hline
...
User's having created a lobby can choose to start a game. \\
...
\begin{center}
  \begin{tabular}{|p{2cm}|c|c|c|p{8cm}|}
    \hline
    Name & Encoding & Size (B) & Default & Comment \\  \hline \hline
    Type & INTEGER & 1 & 0x06 & This identifies the message as \verb START_GAME . \\ \hline
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{|p{2cm}|c|c|c|p{8cm}|}
    \hline
    Name & Encoding & Size (B) & Default & Comment \\  \hline \hline
    Type & INTEGER & 1 & 0x86 & This identifies the message as \verb GAME_STARTING. \\ \hline
...
The server can request clients having joined a certain lobby to start loading a game. Games can take a certain amount of time to allocate resources in a given client, which is why we expect clients to take some time before they give an answer to the server.
...
\begin{center}
  \begin{tabular}{|p{2cm}|c|c|c|p{8cm}|}
    \hline
    Name & Encoding & Size (B) & Default & Comment \\  \hline \hline
    Type & INTEGER & 1 & 0x87 & This identifies the message as \verb LOAD_GAME . \\ \hline
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{|p{2cm}|c|c|c|p{8cm}|}
    \hline
    Name & Encoding & Size (B) & Default & Comment \\  \hline \hline
    Type & INTEGER & 1 & 0x07 & This identifies the message as \verb READY. \\ \hline
    Answer & BYTE & 1 & N/A &    \begin{itemize}    	
\item
	\end{itemize} 
  \end{tabular}
